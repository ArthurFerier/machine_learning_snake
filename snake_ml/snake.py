...
class SnakeGame(object):
    def __init__(self, parents, scores_p, structure,
                 ...
                 generation, batch, screen, speed, size, loaded):
        ...
        self.reset(parents, scores_p, proportion, amplitude, batch, speed, loaded, structure)
        self.moves = moves
        ...
        while True:
            ...
            if self.playing:
                ...
                if tik < 0:
                    ...
                    count = 0  # the 3 first blocks doesn't matter
                    ur = 0
                    um = 0
                    ul = 0
                    ml = 0
                    ...
                    actions = self.snake.brain.think(obs)  # [haut, bas, droite, gauche]
            ...
            if self.see:
                pygame.display.flip()  # turn off if we doesn't want to see the screen
